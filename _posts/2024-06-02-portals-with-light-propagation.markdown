...
The source code of the modified Godot fork can be found here [https://github.com/zer0problem/godot](https://github.com/zer0problem/godot)
It also includes has some changes I've made for different portal related reasons than mentioned here.  
